...
% Requires the custom functions  PTB_plotfig.m and navipage.m and respfunction.m
...
currtime=0;
warning=0;
if ~speed % if not in speed run mode, ask question as normal, otherwise automatically choose answer and continue
    while ~responded
