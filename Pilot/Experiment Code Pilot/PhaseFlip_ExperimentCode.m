...
try
    ...
    for b=1:nblocks
        ...
        for t=1:ntrials
            ...
            % Save trial results
            resulttable(tottrialcount,:)=table(currcond, b, t, RT, Resp, RespEval, warning, gaborpercent,stim.maskintensity, 'VariableNames',{'Condition','Block', ...
